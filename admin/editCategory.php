...
<body>
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        ...
        <br>
        <label>Status:</label>
        <label><input type="radio" name="status" value="1" <?php echo $record["status"] ? 'checked' : ''; ?>> Active</label>
        <label><input type="radio" name="status" value="0" <?php echo !$record["status"] ? 'checked' : ''; ?>> Inactive</label>
